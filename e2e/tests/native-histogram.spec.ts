...
test.describe('Native histograms', () => {
  test('Native histogram panels display an info badge', async ({ metricsReducerView }) => {
    ...
    // finally, we don't use the expectToHaveScreenshot fixture here because the panels look alike in Grafana 11 and Grafana 12 (versions supported in July 2025)
